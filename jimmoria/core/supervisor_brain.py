...
from jimmoria.core.supervisor_intake import SupervisorIntakeDecision, decide_supervisor_intake
from jimmoria.core.supervisor_memory import SupervisorMemoryStore, supervisor_memory_path_for
from jimmoria.core.supervisor_session import SupervisorSessionStore, supervisor_session_path_for
...
class SupervisorBrain:
    ...
    def prepare_turn(self, user_message: str, route_line: str, settings: PersonalAgentSettings) -> SupervisorBrainTurn:
