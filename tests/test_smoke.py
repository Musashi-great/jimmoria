...
class SmokeTest(unittest.TestCase):
    ...
    def test_runtime_3jane_korean_report_request_uses_source_backed_evidence(self) -> None:
        ...
        self.assertIn("Representative Diligence Brief", report)
        self.assertIn("대표님 기준 결론", report)
        ...
        self.assertIn("Official site/docs candidate: [3Jane site](https://www.3jane.xyz/)", report)
        self.assertIn("Official address registry: [3Jane address registry](https://docs.3jane.xyz/developers/addresses)", report)
        self.assertIn("아티클/웹 언급 요약", report)
        ...
        self.assertIn("## 8. Analyst Thesis", report)
        self.assertIn("## 11. Next Research Checklist", report)
        self.assertIn("## 12. Verification Status", report)
        self.assertIn("## 13. Source Appendix", report)
        self.assertIn("## 14. Research Quality Metadata", report)
