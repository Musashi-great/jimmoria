...
class SmokeTest(unittest.TestCase):
    ...
    def test_runtime_3jane_korean_report_request_uses_source_backed_evidence(self) -> None:
        ...
        self.assertIn("## 2. Project Identity", report)
        self.assertIn("## 4. Product & Protocol Mechanics", report)
        self.assertIn("## 5. Token, Chain & Value Capture", report)
        self.assertIn("## 7. Analyst Thesis", report)
        self.assertIn("## 10. Next Research Checklist", report)
        self.assertIn("## 11. Verification Status", report)
        self.assertIn("## 12. Source Appendix", report)
        self.assertIn("## 13. Research Quality Metadata", report)
