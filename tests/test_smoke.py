...
class SmokeTest(unittest.TestCase):
    ...
    def test_runtime_3jane_korean_report_request_uses_source_backed_evidence(self) -> None:
        ...
        self.assertIn("Official site/docs candidate: https://www.3jane.xyz/", report)
        self.assertIn("Official address registry: https://docs.3jane.xyz/developers/addresses", report)
