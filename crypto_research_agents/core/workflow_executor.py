...
from crypto_research_agents.core.dynamic_dispatch import (
    CandidateResult,
    CandidateTask,
...
from crypto_research_agents.core.workflow import WorkflowEdge, WorkflowSpec
...
class WorkflowExecutor:
    ...
    makes the company workflow explicit and replayable without replacing the
